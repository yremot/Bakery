  ...
  return (
    <div className={Style.news_wrap}>
        <section className={Style.news}>
            ...
            <div className={Style.news_list_wrap} id='news_wrap'>
              <Swiper navigation={true} modules={[Navigation]} className="newsSwiper" loop={true}>
                  <SwiperSlide>
                    <div className={`${Style.news_list} news_list is-flex`}>
                      <div className={`${Style.news_list_li} news_list_li`}>
                  ...
                  <SwiperSlide>
                    <div className='news_list is-flex'>
                      <div className='news_list_li'>
                        <p className={`${Style.news_img} ${Style.news_img01}`}>딸기 신메뉴 출시</p>
                        <p className={Style.news_title}>딸기 신메뉴 출시</p>
                        <p className={Style.news_text}>신선한 딸기의 달콤함이 가득한 메뉴를 맛보세요.</p>
