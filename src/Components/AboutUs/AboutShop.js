...
export default function AboutShop() {
    ...
    <div className='aboutus_wrap'>
      <section className='aboutus'>
         ...
         <article className={Style.shop_info}>
             <h3 className='aboutus_title'><BsThreeDotsVertical className='title_icon' />매장 소개</h3>
            ...
            <div className={Style.shop_under_wrap}>
                <p className={Style.shop_info_title}>따뜻하고 편안한 실내<GiCurledLeaf className={Style.icon}/><img src="./images/AboutUs/shop_info2.png" alt="매장사진2" /></p>
 ...
 또한, 저희 매장은 편리한 위치에 위치해 있어 접근성이 좋으며, 주변에 주차장도 충분히 마련되어 있습니다. 매일 많은 분들이 찾는 저희 베이커리로 오셔서 특별한 시간을 보내세요.</p>
                <p className={Style.shop_info_img3}></p>
